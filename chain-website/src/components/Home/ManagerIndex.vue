<template>
  <div id="content-wrapper">
    ...
    <a-table :columns="columns" :dataSource="data">
      <span slot="optType" slot-scope="optType,doc">
      ...
      setTimeout(() => {
        ...
        if (this.nowOptType=="docVerify") {
          ...
          */
          ...
          this.$router.push("/Home/managerIndex1");
          //this.doc.doc="5cd7c1b9825a8948e757ca09";
          //this.doc="5cd7c1b9825a8948e757ca09";
          //doc.doc="5cd7c1b9825a8948e757ca09";
          //this.doc.subtime="2019-12-09 10:05:01";
        }
      }, 3000);
    },
    handleCancel(e) {
