package com.crowdchain.crowdchaindemo.network;
...
public class CreateChannel {
    ...
    public static void main(String[] args) {
        try {
            ...
            String ORG1_USR_ADMIN_PK="../network_resources/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp/keystore";
            String ORG1_USR_ADMIN_CERT="../network_resources/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp/admincerts";
            //File pkFolder1 = new File(Config.ORG1_USR_ADMIN_PK);
            File pkFolder1 = new File(ORG1_USR_ADMIN_PK);
            File[] pkFiles1 = pkFolder1.listFiles();
            //File certFolder1 = new File(Config.ORG1_USR_ADMIN_CERT);
            File certFolder1 = new File(ORG1_USR_ADMIN_CERT);
			 ...
			 */
            Enrollment enrollOrg1Admin = Util.getEnrollment(ORG1_USR_ADMIN_PK, pkFiles1[0].getName(),
                    ORG1_USR_ADMIN_CERT, certFiles1[0].getName());
            org1Admin.setEnrollment(enrollOrg1Admin);
            org1Admin.setMspId(Config.ORG1_MSP);
            org1Admin.setName(Config.ADMIN);


            String ORG2_USR_ADMIN_PK="../network_resources/crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp/keystore";
            String ORG2_USR_ADMIN_CERT="../network_resources/crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp/admincerts";
            UserContext org2Admin = new UserContext();
            //File pkFolder2 = new File(Config.ORG2_USR_ADMIN_PK);
            File pkFolder2 = new File(ORG2_USR_ADMIN_PK);
            File[] pkFiles2 = pkFolder2.listFiles();
            //File certFolder2 = new File(Config.ORG2_USR_ADMIN_CERT);
            File certFolder2 = new File(ORG2_USR_ADMIN_CERT);
			 ...
			 */
            Enrollment enrollOrg2Admin = Util.getEnrollment(ORG2_USR_ADMIN_PK, pkFiles2[0].getName(),
                    ORG2_USR_ADMIN_CERT, certFiles2[0].getName());
            ...
            //String CHANNEL_CONFIG_PATH="../network_resources/config/channel.tx";
