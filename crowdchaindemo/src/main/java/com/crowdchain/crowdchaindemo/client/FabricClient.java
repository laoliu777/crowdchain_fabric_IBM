package com.crowdchain.crowdchaindemo.client;
...
public class FabricClient {
     ...
     * @throws InvalidArgumentException
     */
    public com.crowdchain.crowdchaindemo.client.ChannelClient createChannelClient(String name) throws InvalidArgumentException {
        Channel channel = instance.newChannel(name);
        com.crowdchain.crowdchaindemo.client.ChannelClient client = new com.crowdchain.crowdchaindemo.client.ChannelClient(name, channel, this);
        return client;
    }
