...
public class ChannelClient {
    ...
    String name;
    Channel channel;
    com.crowdchain.crowdchaindemo.client.FabricClient fabClient;
    ...
    public com.crowdchain.crowdchaindemo.client.FabricClient getFabClient() {
        return fabClient;
    }
     ...
     * @param fabClient
     */
    public ChannelClient(String name, Channel channel, com.crowdchain.crowdchaindemo.client.FabricClient fabClient) {
        this.name = name;
