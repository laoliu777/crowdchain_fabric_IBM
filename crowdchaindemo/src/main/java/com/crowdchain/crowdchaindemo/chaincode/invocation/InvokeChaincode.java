...
public class InvokeChaincode {
    ...
    public static void main(String args[]) {
        //public String queryRep(String testid){
        try {
            Util.cleanUp();
            ...
            //{比赛ID，姓名（来源：解析txt文件名），签名（程序生成），哈希值（程序生成）}
            String[] arguments = { "1000010", "Chevy0", "Volt", "Red", "Nick" };
            request.setArgs(arguments);
            String[] arguments2 = { "1000011", "Chevy1", "Volt", "Red", "Nick" };
            request.setArgs(arguments2);
